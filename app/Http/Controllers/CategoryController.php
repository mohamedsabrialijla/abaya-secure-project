...
class CategoryController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $o=Category::withCount('products')->where('full_width',0)->orderBy('id','DESC');
        if($request->name){
        ...
        return view('system_admin.categories.index',compact('out'));
    }
    ...
    public function showUpdateView(Request $request){
        ...
        return view('system_admin.categories.update',compact('out','products'));
    ...
    public function Update(Request $request,$id){
        ...
        $out->name_en=$request->name_en;
        $out->logo=$request->image;
        $out->full_width=$request->full_width;
