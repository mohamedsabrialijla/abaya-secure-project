...
define('PRODUCTION_CERTIFICATE_KEY', url('apple_pay/abayasqaureapplepay.pem'));
//define('PRODUCTION_CERTIFICATE_KEY', public_path('apple_pay/alreemCertificates.pem'));
//define('PRODUCTION_CERTIFICATE_PATH', public_path('apple_pay/'.'alreemCertificates.p12'));
define('PRODUCTION_CERTIFICATE_PATH', public_path('apple_pay/apple_pay.cer'));

// This is the password you were asked to create in terminal when you extracted ApplePay.key.pem
define('PRODUCTION_CERTIFICATE_KEY_PASS', 'abayasq@123');
//define('PRODUCTION_CERTIFICATE_KEY_PASS', 'abayasq@123');
...
define('PRODUCTION_MERCHANTIDENTIFIER', 'merchant.com.selsela.abayasquare');
//define('PRODUCTION_MERCHANTIDENTIFIER', 'merchant.sa.urway.applePay');
...
define('PRODUCTION_DISPLAYNAME', 'Alreem');

/*
define('TERMINAL_ID','');
define('PASSWORD','password');
define('KEY', '');
define('URL', 'https://payments-dev.urway-tech.com/URWAYPGService/transaction/jsonProcess/JSONrequest');
define('DEBUG', 'true');*/
?>
