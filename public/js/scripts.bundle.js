	...
	$.fn[pluginName] = function(options) {
		...
		var Plugin = {
			...
			init: function(options) {
				...
				// on event after layouts had done setup, show datatable
				$(datatable).on(pfx + 'datatable-on-layouts-updated', Plugin.afterRender);
				...
				Plugin.setHeadTitle();
				if (Plugin.getOption('layouts.footer')) {
			...
			/**
			 * One time layouts update on init
			 */
			layoutUpdate: function() {
				...
				$(datatable).trigger(pfx + 'datatable-on-layouts-updated', {table: $(datatable.wrap).attr('id')});
			},
			...
			/**
			 * After render event, called by "datatable-on-layouts-updated"
			 * @param e
			 * @param args
			 */
			...
			setupBaseDOM: function() {
				...
				if (Plugin.getOption('layouts.minHeight'))
					$(datatable.table).css('min-height', Plugin.getOption('layouts.minHeight'));

				if (Plugin.getOption('layouts.height'))
					$(datatable.table).css('max-height', Plugin.getOption('layouts.height'));
							...
							if (typeof column.subtable !== 'undefined' && column.subtable) {
								...
								$(td).
									...
									html($('<a/>').
										...
										append($('<i/>').addClass(Plugin.getOption('layouts.icons.rowDetail.collapse'))));
							}
						}
					});
				});
					...
					init: function() {
						...
						if (options.layout.scroll) {
							...
							if ($(scrollable).find('.' + pfx + 'datatable-row').length > 0 && $(scrollable).length > 0) {
								...
								if (Plugin.getOption('layouts.customScrollbar') && util.detectIE() != 10 && screen > util.getBreakpoint('lg')) {
			...
			paging: function(meta, callback) {
				var pg = {
					...
					populate: function() {
						...
						var icons = Plugin.getOption('layouts.icons.pagination');
						...
						$.each(Plugin.getOption('toolbar.layouts'), function(i, layout) {
					...
					updatePerpage: function(e) {
						e.preventDefault();
						// if (Plugin.getOption('layouts.height') === null) {
					...
					/**
					 * Update pagination layouts breakpoint
					 */
			...
			setupSubDatatable: function() {
				...
				var toggleSubTable = function(e) {
					...
					if ($(parentRow).hasClass(pfx + 'datatable-row-subtable-expanded')) {
						$(icon).addClass(Plugin.getOption('layouts.icons.rowDetail.collapse'));
						...
						$(icon).addClass(Plugin.getOption('layouts.icons.rowDetail.expand'));
							...
							if (typeof column.subtable !== 'undefined' && column.subtable) {
								...
								$(td).
									html($('<a/>').
										...
										append($('<i/>').css('width', $(td).data('width')).addClass(Plugin.getOption('layouts.icons.rowDetail.collapse'))));
							}
						}
					});
				});
			...
			spinnerCallback: function(block, target) {
				...
				// get spinner options
				var spinnerOptions = Plugin.getOption('layouts.spinner');
				// spinner is disabled
			...
			autoHide: function() {
				...
				var toggleHiddenColumns = function(e) {
					...
					if (!$(detailRow).hasClass(pfx + 'datatable-row-detail')) {
						$(this).find('i').removeClass(Plugin.getOption('layouts.icons.rowDetail.collapse')).addClass(Plugin.getOption('layouts.icons.rowDetail.expand'));
						...
						$(this).find('i').removeClass(Plugin.getOption('layouts.icons.rowDetail.expand')).addClass(Plugin.getOption('layouts.icons.rowDetail.collapse'));
						$(detailRow).remove();
					}
				};
							...
							if($(this).find('.' + pfx + 'datatable-toggle-detail').length === 0) {
								...
								$(this).prepend($('<td/>').
										...
										append($('<a/>').
											...
											append('<i class="' + Plugin.getOption('layouts.icons.rowDetail.collapse') + '"></i>')));
							}
			...
			sorting: function() {
				var sortObj = {
					...
					setIcon: function() {
						...
						var icons = Plugin.getOption('layouts.icons.sort');
		...
		var Extension = {
			...
			init: function() {
				if (Extension.selectorEnabled()) {
					...
					$(datatable).on(pfx + 'datatable-on-layouts-updated', function(e, args) {
...
KTUtil.ready(function() {
    ////////////////////////////////////////////////////
    // Layout Base Partials(mandatory for core layouts)//
    ////////////////////////////////////////////////////
