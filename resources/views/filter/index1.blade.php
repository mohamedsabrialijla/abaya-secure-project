                    ...
                    <div class="card side-products">
                        ...
                        <div class="card-body  single-filter-box">
                            ...
                            <div class="filter_row">
                                <p class="filter-title"><a data-toggle="collapse" href="#collapseCat1" aria-expanded="false" aria-controls="collapseExample">@lang('website.top_categories')</a></p>
        ...
        @foreach($products_without_paginate as $product)
            {
              ...
              item_category: "@if(isset($product->category) && $product->category->name != ''){{$product->category->name}}@endif",
              item_list_id: "@if(isset($product->category) && $product->category->name != ''){{$product->category->name}}@endif",
              item_list_name: "@if(isset($product->category) && $product->category->name != ''){{$product->category->name}}@endif",
              item_variant: "",
              location_id: "",
