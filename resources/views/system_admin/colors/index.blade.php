                ...
                <div class="col">
                    <form class="form-inline" style="float: right">
                        <div class="form-group m-form__group">
                            ...
                            @component('components.serach.inputwithsearch',['inputs'=>['name'=>'اسم اللون']])
                            @endcomponent
                            <a href="{{route('system.colors.index')}}"
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            @foreach($out as $o)
                                <tr id="TR_{{$o->id}}">
                                    ...
                                    <td class="text-center">
                                        <p>{{ $o->hexa }}</p>
                                        <span class="label mr-2" style="background-color: {{$o->hexa}}"></span>
                                    </td>
                                    <td class="text-center">
                                        @if($o->status == 1)
                                    ...
                                    <td class="text-center">
                                        ...
                                        <ul class="list-inline">
                                            @if(auth('system_admin')->user()->can('edit_colors','system_admin'))
                                                <li>
                                                    <a href="{{route('system.colors.update',$o->id)}}"
                                            ...
                                            @endif
                                            @if(auth('system_admin')->user()->can('delete_colors','system_admin'))
                                                <li>
                                                    <?php if ($o->can_del) { ?>
                                                    <button class="{{config('layout.classes.delete')}} mt-2 btn-del"
                                                            data-id="<?= $o->id ?>"
                                                            data-toggle="tooltip" data-theme="dark"
                                                            data-url="{{route('system.colors.delete')}}"
