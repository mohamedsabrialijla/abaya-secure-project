    ...
    <div class="card card-custom">
        <div class="card-header  card-header-tabs-line">
            ...
            <div class="card-toolbar">
                <span>
                    <a class="{{ config('layout.classes.delete') }}" href="{{ route('system.users.index') }}">
                            ...
                            <form action="{{ route('user.wallet') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">النقاط</label>
                                            <input type="hidden" name="id" id="" value="{{ $out->id }}">
                                            <input type="text" class="form-control" value="{{ $out->points }}"
                                    ...
                                    <tbody>
                                        @foreach ($orders as $o)
                                            <tr id="TR_{{ $o->id }}">
                                                ...
                                                <td class="text-center"> {{ $o->total }}
                                                    {{ \App\Models\Settings::get('currency_ar') }}</td>
