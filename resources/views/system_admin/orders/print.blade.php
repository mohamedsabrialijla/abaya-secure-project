        ...
        <div class="bill-wrapper-container">
            ...
            <div class="customer-info">
                ...
                <div class="customer-info-col">
                    ...
                    <div>
                        <img src="{{ asset('logos/logo_abaya.png') }}" alt="" width="40" height="40">
                    </div>
                    <div>
                        <label>المتجر :</label>
                        <span> {{@$app_name}}</span>
                    ...
                    <div>
                        ...
                        <span dir="ltr">#{{@$order->invoice_number}}</span>
                    </div>
                    <div>
                        <label> التاريخ:</label>
                ...
                <div class="customer-info-col">
                    ...
                    <div>
                        ...
                        <span> {{@$order->customer->name??@$order->address->name}}</span>
                    </div>
                    <div>
                        <label>الموبايل :</label>
                        <span dir="ltr">+{{@$order->address->mobile}}</span>
                    </div>
                    <div>
                        <label>البريد الالكتروني:</label>
            ...
            <div class="bill-table">
                <table>
                    ...
                    @foreach($order->products as $product)
                        @php $total_cost+=$product->total; @endphp
                        <tr>
                            <td>1</td>
                            ...
                            <td> {{@$product->price}}  </td>
                            <td> {{@$product->qty}} </td>
                            <td> {{isset($product->coupon->code)?@$product->coupon->code:'-'}}  </td>
                            <td> {{$product->discount_ratio?@$product->discount_ratio.('%'):'-'}} </td>
                            <td>
                                {{$product->total_before_discount}}
                            </td>
                        </tr>
                    ...
                    <tr class="vat">
                        <td colspan="6"></td>
                        <td> الضريبة  <span>({{@$order->tax_ratio}}%)</span></td>
                        <td>
                            {{($order->tax)}}
                        </td>
                    </tr>
