...
@section('breadcrumbs')
    <x-breadcrumbs :breadcrumbs="[
        ...
        ['page' => route('system.payouts.index'), 'title' => 'المستحقات'],
    ]" />
@endsection
            ...
            <div class="col">
                <form class="form-inline" id="form" style="float: right">
                    <div class="form-group m-form__group">
                        ...
                        @endcomponent
                        <a href="{{ route('system.payouts.index') }}" class="{{ config('layout.classes.delete') }} mb-4 ml-5">
                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">المستحقات</th>
                                ...
                                @foreach ($out as $o)
                                    <tr id="TR_{{ $o->id }}">
                                        ...
                                        <td class="text-center">
                                            <p>
                                                <a
                                                    href="{{ route('system.products.index') }}?store_id={{ $o->id }}">{{ @$o->orders()->count() }}</a>
                                            </p>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <ul class="list-inline">
                                                <li>
                                                    <a href="{{ route('system.payouts.orders', ['id' => $o->id]) }}"
                                                        class=" {{ config('layout.classes.warning') }} mt-2 "
                                                        title="عرض الطلبات" data-toggle="tooltip" data-theme="dark"
                                                        data-placement="top">
                                                        <i class="fa fa-box"></i> عرض الطلبات
                                                    </a>
