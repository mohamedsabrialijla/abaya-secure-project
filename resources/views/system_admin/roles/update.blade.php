...
'action'=>'edit',
        ...
        <div class="row justify-content-center">
            ...
            <div class="w-100"></div>
            <div class="col-md-6">
                @component('components.input',['data'=>$out->name,'name'=>'name','text'=>'اسم الصلاحية','placeholder'=>'اسم الصلاحية','icon'=>'fa-user-alt'])
                @endcomponent
            </div>
            <div class="w-100"></div>
                                    ...
                                    <td style="text-align: center">
                                        <label class="checkbox justify-content-center">
                                            <input type="checkbox"
                                                ...
                                                {{in_array($permission_map . '_' . $model, $out->permissions->pluck('name')->toArray())?'checked':''}}
                                            ><span></span>
                                        </label>
                                    </td>
                                @endforeach
