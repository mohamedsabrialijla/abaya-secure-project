                ...
                <div class="col">
                    <form class="form-inline" style="float: right">
                        <div class="form-group m-form__group">
                            ...
                            @component('components.serach.inputwithsearch',['inputs'=>['name'=>'اسم المقاس']])
                            @endcomponent
                                ...
                                <tr id="TR_{{$o->id}}">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <ul class="list-inline">
                                            ...
                                            @if(auth('system_admin')->user()->can('edit_sizes','system_admin'))

                                                <li>
                                                    <a href="{{route('system.sizes.update',$o->id)}}"
                                            ...
                                            @endif
                                            @if(auth('system_admin')->user()->can('delete_sizes','system_admin'))
