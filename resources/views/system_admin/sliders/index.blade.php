            ...
            {{-- <div class="col">
                <form class="form-inline" id="form" style="float: right">
                    <div class="form-group m-form__group">
                        ...
                        @endcomponent
                        <a href="{{ route('system.sliders.index') }}" class="{{ config('layout.classes.delete') }} mb-4 ml-5">
                                    ...
                                    <tr id="TR_{{ $o->id }}">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <ul class="list-inline">
                                                ...
                                                <a href="{{ route('system.sliders.view', ['slider' => $o->id]) }}"
                                                ...
                                                @if (auth('system_admin')->user()->can('edit_stores', 'system_admin'))
                                                    <li>
                                                        <a href="{{ route('system.sliders.update', $o->id) }}"
