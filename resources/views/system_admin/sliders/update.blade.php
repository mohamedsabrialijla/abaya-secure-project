    ...
    @component('components.AddEditCard', [
        ...
        <div class="row">
            <div class="col-10">
                <div class="row">
                    <div class="col-md-6">
                        {{-- @component('components.upload_image', ['data'=>$out->image_url,'name' => 'image', 'text' => 'صورة السلايدر', 'hint' => ''])
                        @endcomponent --}}
                        @component('components.upload_image',['data'=>$out->image,'name'=>'image','text' => 'صورة السلايدر','hint'=>''])
                   @endcomponent
                    </div>
