                ...
                <div class="col">
                    <form class="form-inline" style="float: right">
                        <div class="form-group m-form__group">
                            ...
                            @endcomponent
                            <a href="{{route('system.styles.index')}}"
                                ...
                                <tr id="TR_{{$o->id}}">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <ul class="list-inline">
                                            @if(auth('system_admin')->user()->can('edit_style','system_admin'))
                                                <li>
                                                    <a href="{{route('system.styles.update',$o->id)}}"
                                            ...
                                            @endif
                                            @if(auth('system_admin')->user()->can('delete_style','system_admin'))
                                                <li>
                                                    <?php if ($o->can_del) { ?>
                                                    <button class="{{config('layout.classes.delete')}} mt-2 btn-del"
                                                            data-id="<?= $o->id ?>"
                                                            data-toggle="tooltip" data-theme="dark"
                                                            data-url="{{route('system.styles.delete')}}"
