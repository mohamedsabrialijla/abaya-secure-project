                    ...
                    <div class="nav-desktop">
                        <div class="primary-menu-container">
                            <ul id="mega_main_menu_ul" class="nav-menu">
                                {{-- <li class="menu-item-has-children dropdown"><a href="#" target="_parent">المتجر</a>
                                    <ul class="sub-menu sub-menu-elementor default">
                                        <li>
                                            <section class="elementor-section-boxed">
                                                <div class="elementor-container">
                                                    <div class="elementor-column col-lg-3">
                                                        <div class="elementor-element-populated">
                                                            <div class="elementor-widget elementor-widget-heading">
                                                                <div class="elementor-widget-container">
                                                                    <h2 class="elementor-heading-title">عبايات</h2>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <ul class="elementor-icon-list-items">
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                                                <span>عبايات ساده</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                                                <span>عبايات فضفاضه</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                                                <span>عبايات ثقيله</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                    ...
                                                    <div class="elementor-column col-lg-3">
                                                        <div class="elementor-element-populated">
                                                            <div class="elementor-widget elementor-widget-heading">
                                                                <div class="elementor-widget-container">
                                                                    <h2 class="elementor-heading-title">فساتين</h2>
                                                                </div>
                                                            </div>
                                                            <div class="elementor-widget">
                                                                <div class="elementor-widget-container">
                                                                    <ul class="elementor-icon-list-items">
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                                                <span>غساتين ساده</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                                                <span>فساتين مطرزه</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                                                <span>فساتين مغربي</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                    ...
                                                    <div class="elementor-column col-lg-3">
                                                        <div class="elementor-element-populated">
                                                            <div class="elementor-widget elementor-widget-heading">
                                                                <div class="elementor-widget-container">
                                                                    <h2 class="elementor-heading-title">جلابيات</h2>
                                                                </div>
                                                            </div>
                                                            <div class="elementor-widget">
                                                                <div class="elementor-widget-container">
                                                                    <ul class="elementor-icon-list-items">
                                                                        ...
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                                                <span>جلابيات خفيفه</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                                                <span>جلابيات ثقيله</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                                                <span>جلابيات مطرزه</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
                                                    ...
                                                    <div class="elementor-column col-lg-3">
                                                        <div class="elementor-element-populated">
                                                            <div class=" elementor-widget elementor-widget-heading">
                                                                <div class="elementor-widget-container">
                                                                    <h2 class="elementor-heading-title">أخري</h2>
                                                                </div>
                                                            </div>
                                                            <div class="elementor-element-170e1c3 elementor-widget">
                                                                <div class="elementor-widget-container">
                                                                    <ul class="elementor-icon-list-items">
                                                                        <li class="elementor-icon-list-item">
                                                                            <a href="#" target="_parent">
