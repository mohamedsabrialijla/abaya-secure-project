    ...
    <div class="container">
        <div class="designer_header">
            <div class="designer_box">
                <div class="image"><img src="{{ $cat->image_url }}" width="100" height="100" class=" lazyloaded" alt="img"></div>
                <div class="info mb-0">
                    <h1 class="m-0">{{ $cat->name }}</h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="box_product wow fadeInUp">
                        <figure>
                            ...
                            <div class="label-group">
                                ...
                                <div class="product-label label-sale">{{ $m->discount_ratio }}%</div>
                                @endif
                            </div>
                        </figure>
...
dataLayer.push({
  ...
  ecommerce: {
    ...
    items: [
        @foreach($products_without_paginate as $product)
            {
