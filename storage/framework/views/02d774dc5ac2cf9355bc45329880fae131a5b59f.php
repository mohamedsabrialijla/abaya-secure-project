                ...
                <div class="col">
                    <form class="form-inline" style="float: right">
                        <div class="form-group m-form__group">
                            ...
                            <?php echo $__env->renderComponent(); ?>
                            <a href="<?php echo e(route('system.categories_special.index')); ?>"
                                    ...
                                    <td class="text-center">
                                        ...
                                        <ul class="list-inline">
                                            <?php if(auth('system_admin')->user()->can('edit_categories','system_admin')): ?>
                                                <li>
                                                    <a href="<?php echo e(route('system.categories_special.update',$o->id)); ?>"
                                            ...
                                            <?php if(auth('system_admin')->user()->can('delete_categories','system_admin')): ?>
                                                <li>
                                                    ...
                                                    <button class="<?php echo e(config('layout.classes.delete')); ?> mt-2 btn-del"
                                                            ...
                                                            data-url="<?php echo e(route('system.categories_special.delete')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/new/resources/views/system_admin/categories_special/index.blade.php ENDPATH**/ ?>