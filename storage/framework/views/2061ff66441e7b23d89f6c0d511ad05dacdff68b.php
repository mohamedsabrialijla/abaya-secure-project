...
'Disname'=>'الألوان',
'Disinfo'=>'ادارة الألوان',
'add_url'=>'system.colors.create',
'module'=>'colors',
'actions'=>[
        [
           'route'=>'system.colors.activate',
           'icon'=>config('layout.icons.activate_icon'),
           'text'=>'تفعيل',
           'role'=>"activate",
       ],
       [
           'route'=>'system.colors.deactivate',
           'icon'=>config('layout.icons.deactivate_icon'),
           'text'=>'تعطيل',
           'role'=>"activate",
       ],
       [
            'route'=>'system.colors.delete',
                ...
                <div class="col">
                    <form class="form-inline" style="float: right">
                        <div class="form-group m-form__group">
                            ...
                            <?php $__env->startComponent('components.serach.inputwithsearch',['inputs'=>['name'=>'اسم اللون']]); ?>
                            <?php echo $__env->renderComponent(); ?>
                            <a href="<?php echo e(route('system.colors.index')); ?>"
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php $__currentLoopData = $out; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="TR_<?php echo e($o->id); ?>">
                                    ...
                                    <td class="text-center">
                                        <p><?php echo e($o->hexa); ?></p>
                                        <span class="label mr-2" style="background-color: <?php echo e($o->hexa); ?>"></span>
                                    </td>
                                    <td class="text-center">
                                        <?php if($o->status == 1): ?>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <ul class="list-inline">
                                            <?php if(auth('system_admin')->user()->can('edit_colors','system_admin')): ?>
                                                <li>
                                                    <a href="<?php echo e(route('system.colors.update',$o->id)); ?>"
                                            ...
                                            <?php endif; ?>
                                            <?php if(auth('system_admin')->user()->can('delete_colors','system_admin')): ?>
                                                <li>
                                                    <?php if ($o->can_del) { ?>
                                                    <button class="<?php echo e(config('layout.classes.delete')); ?> mt-2 btn-del"
                                                            data-id="<?= $o->id ?>"
                                                            data-toggle="tooltip" data-theme="dark"
                                                            data-url="<?php echo e(route('system.colors.delete')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/resources/views/system_admin/colors/index.blade.php ENDPATH**/ ?>