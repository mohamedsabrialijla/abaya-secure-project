                ...
                <div class="col">
                    <form class="form-inline" style="float: right">
                        <div class="form-group m-form__group">
                            ...
                            <?php $__env->startComponent('components.serach.inputwithsearch',['inputs'=>['name'=>'اسم المحافظة']]); ?>
                            <?php echo $__env->renderComponent(); ?>
                            <a href="<?php echo e(route('system.govs.index')); ?>"
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php $__currentLoopData = $out; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="TR_<?php echo e($o->id); ?>">
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo e(route('system.areas.index',['gov_id'=>$o->id])); ?>"><?php echo e($o->areas->count()); ?></a>
                                    </td>
                                    <td class="text-center">

                                        <ul class="list-inline">

                                            <?php if(auth('system_admin')->user()->can('edit_govs','system_admin')): ?>

                                                <li>
                                                    <a href="<?php echo e(route('system.govs.update',$o->id)); ?>"
                                            ...
                                            <?php endif; ?>
                                            <?php if(auth('system_admin')->user()->can('delete_govs','system_admin')): ?>
                                                ...
                                                <li>
                                                    ...
                                                    <button class="<?php echo e(config('layout.classes.delete')); ?> mt-2 btn-del"
                                                            ...
                                                            data-url="<?php echo e(route('system.govs.delete')); ?>"
                                                ...
                                                <li>
                                                    <a href="<?php echo e(route('system.areas.index',['gov_id'=>$o->id])); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/resources/views/system_admin/govs/index.blade.php ENDPATH**/ ?>