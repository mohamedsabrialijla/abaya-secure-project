...
<?php $__env->startSection('page_content'); ?>
    ...
    <?php $__env->startComponent('components.ShowCard', [
        'Disname' => 'السلايدرز',
        'Disinfo' => 'ادارة السلايدرز',
        'add_url' => 'system.sliders.create',
        'module' => 'stores',
        'actions' => [
        [
        'route' => 'system.sliders.delete',
                                    ...
                                    <tr id="TR_<?php echo e($o->id); ?>">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <ul class="list-inline">
                                                ...
                                                <a href="<?php echo e(route('system.sliders.view', ['slider' => $o->id])); ?>"
                                                ...
                                                <?php if(auth('system_admin')->user()->can('edit_stores', 'system_admin')): ?>
                                                    <li>
                                                        <a href="<?php echo e(route('system.sliders.update', $o->id)); ?>"
                                                ...
                                                <?php if(auth('system_admin')->user()->can('delete_stores', 'system_admin')): ?>
                                                        <li>
                                                            <button type="button" data-id="<?= $o->id ?>"
                                                                data-url="<?php echo e(route('system.sliders.delete')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/resources/views/system_admin/sliders/index.blade.php ENDPATH**/ ?>