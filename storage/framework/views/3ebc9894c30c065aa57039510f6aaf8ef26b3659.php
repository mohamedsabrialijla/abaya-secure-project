                ...
                <div class="col">
                    <form class="form-inline" style="float: right">
                        <div class="form-group m-form__group">
                            ...
                            <?php echo $__env->renderComponent(); ?>
                            <a href="<?php echo e(route('system.clothes.index')); ?>"
                                ...
                                <tr id="TR_<?php echo e($o->id); ?>">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <ul class="list-inline">
                                            <?php if(auth('system_admin')->user()->can('edit_clothes','system_admin')): ?>
                                                <li>
                                                    <a href="<?php echo e(route('system.clothes.update',$o->id)); ?>"
                                            ...
                                            <?php endif; ?>
                                            <?php if(auth('system_admin')->user()->can('delete_clothes','system_admin')): ?>
                                                <li>
                                                    <?php if ($o->can_del) { ?>
                                                    <button class="<?php echo e(config('layout.classes.delete')); ?> mt-2 btn-del"
                                                            data-id="<?= $o->id ?>"
                                                            data-toggle="tooltip" data-theme="dark"
                                                            data-url="<?php echo e(route('system.clothes.delete')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/new/resources/views/system_admin/clothes/index.blade.php ENDPATH**/ ?>