    ...
    <?php if(config('layout.extras.notifications.display')): ?>
        <?php if(config('layout.extras.notifications.layout') == 'offcanvas'): ?>
            <div class="topbar-item">
                <div class="btn btn-icon btn-clean btn-lg mr-1 pulse pulse-primary" id="kt_quick_notifications_toggle">
                    <?php echo e(Metronic::getSVG("media/svg/icons/General/Notifications1.svg", "svg-icon-xl svg-icon-primary")); ?>
        ...
        <?php else: ?>
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px"  id="NotificationBill">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        <?php echo $__env->make('layouts.partials.extras.dropdown._notifications', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </form>
                </div>
            </div>
        <?php endif; ?>
    ...
    <?php if(config('layout.extras.quick-actions.display')): ?>
        ...
        <?php else: ?>
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <?php echo $__env->make('layouts.partials.extras.dropdown._quick-actions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <?php if(config('layout.extras.cart.display')): ?>
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                <form>
                    <?php echo $__env->make('layouts.partials.extras.dropdown._cart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </form>
            </div>
        </div>
    <?php endif; ?>
    ...
    <?php if(config('layout.extras.languages.display')): ?>
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                <?php echo $__env->make('layouts.partials.extras.dropdown._languages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    <?php endif; ?>
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2">
                        <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?php echo e(Auth::guard('system_admin')->user()->name); ?></span>
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    <?php echo $__env->make('layouts.partials.extras.dropdown._user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        <?php endif; ?>
    <?php endif; ?>
</div>
<?php /**PATH /home/abayasquare/public_html/new/resources/views/layouts/partials/extras/_topbar.blade.php ENDPATH**/ ?>