...
<div class="container wrapper">
    ...
    <div class="row cart-body">
        <form class="form-horizontal" action="<?php echo e(route('applepayindex')); ?>" method="post" id="orderForm">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />

            <input type="hidden" class="form-control" name="trackid" value="<?php echo e($out->id); ?>" />
            <input type="hidden" name="amount" class="form-control" value="<?php echo e($out->amount); ?>" />
                    ...
                    <div class="panel-body">
                        ...
                        <script type="text/javascript">
                            ...
                            if (window.ApplePaySession) {
                                ...
                                var merchantIdentifier = '<?php echo e($PRODUCTION_MERCHANTIDENTIFIER); ?>';
                            ...
                            document.getElementById("applePay").onclick = function(evt) {
                                ...
                                var runningAmount 	= <?php echo e($out->amount); ?>;
                                var runningPP		= 0;
                                ...
                                var paymentRequest = {
                                    currencyCode: '<?php echo e($PRODUCTION_CURRENCYCODE); ?>',
                                    countryCode: '<?php echo e($PRODUCTION_COUNTRYCODE); ?>',
                                    ...
                                    total: {
                                        label: '<?php echo e($PRODUCTION_DISPLAYNAME); ?>',
                                        amount: runningTotal()
                                    },
                                ...
                                session.onshippingcontactselected = function(event) {
                                    ...
                                    var newTotal = { type: 'final', label: '<?php echo e($PRODUCTION_DISPLAYNAME); ?>', amount: runningTotal() };
...
<?php /**PATH /home/abayasquare/public_html/resources/views/apple_payment/index.blade.php ENDPATH**/ ?>