                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <?php if(auth('system_admin')->user()->can('edit_products', 'system_admin')): ?>
                                            ...
                                            <li>
                                                ...
                                                <a class="<?php echo e(config('layout.classes.edit')); ?> mt-2"
                                                    href="<?php echo e(route('system.products.orders', $o->id)); ?>">
                                                    <i class="fa fa-file "></i>
                                                    الطلبات
                                                </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/new/resources/views/system_admin/products/index.blade.php ENDPATH**/ ?>