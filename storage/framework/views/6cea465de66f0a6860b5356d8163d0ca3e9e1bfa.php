...
} elseif ($_instance->childHasBeenRendered('drpUIi4')) {
    $componentId = $_instance->getRenderedChildComponentId('drpUIi4');
    $componentTag = $_instance->getRenderedChildComponentTagName('drpUIi4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('drpUIi4');
} else {
    $response = \Livewire\Livewire::mount('feature-products', []);
    $html = $response->html();
    $_instance->logRenderedChild('drpUIi4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </table>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/new/resources/views/system_admin/products/features.blade.php ENDPATH**/ ?>