        ...
        <div class="container">
            <div class="designer_header">
                <div class="designer_box">
                    <div class="image"><img src="<?php echo e($store->image); ?>" width="100" height="100" class=" lazyloaded"
                            alt="img"></div>
                    <div class="info mb-0">
                        <h1 class="m-0"><?php echo e($store->name); ?></h1>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('web.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/new/resources/views/web/single_store.blade.php ENDPATH**/ ?>