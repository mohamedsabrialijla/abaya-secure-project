             ...
             <div class="col-md-6">
               ...
               <select class="js-example-basic-multiple col-md-12" name="categories[]" multiple="multiple">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option <?php if(isset($product_categories) && $product_categories != '' && in_array($p->id,$product_categories)): ?> selected <?php endif; ?> value="<?php echo e($p->id); ?>"><?php echo e($p->name_ar); ?></option>
                        ...
                        <div class="m-content">
                            <div class="row clothesValue">
                                <?php $__currentLoopData = $clothes_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cloth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-4"> <input type="checkbox" name="clothes[]"  value="<?php echo e($cloth->id); ?>" <?php echo e(in_array($cloth->id,$product_clothes)? 'checked':''); ?>>
                        ...
                        <div class="m-content">
                            <div class="row styleValue">
                                <?php $__currentLoopData = $style_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $style): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-4"> <input type="checkbox" name="style[]"  value="<?php echo e($style->id); ?>" <?php echo e(in_array($style->id,$product_style)? 'checked':''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/resources/views/system_admin/products/update.blade.php ENDPATH**/ ?>