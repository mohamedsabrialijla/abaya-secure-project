...
<head>
    ...
    <title><?php echo e($settings->valueOf('project_name_' . $lang)); ?> <?php echo $__env->yieldContent('title'); ?></title>

    <link href="https://fonts.googleapis.com/css2?family=Tajawal:wght@200;300;400;500;600;700;800;900&display=swap"
        rel="stylesheet">

    <!-- Fontawesome 6 -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendor/fontawesome/all.css')); ?>">
    ...
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/style-ltr.css')); ?>">
    <?php endif; ?>

    <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('logos/logo_abaya.png')); ?>" />
...
<!-- End Google Tag Manager (noscript) -->
                ...
                <div class="widget_left col-lg-6 d-flex justify-content-center justify-content-lg-start">
                    <div class="top-right">
                        <ul class="contact-info-two">
                            <li><a href="mailto:<?php echo e($settings->valueOf('email')); ?>" aria-label="Mail"><i
                                        class="fal fa-envelope"></i><?php echo e($settings->valueOf('email')); ?></a>
                            </li>
                        </ul>
                        <ul class="social-links clearfix">
                            <li><a href="<?php echo e($settings->valueOf('twitter')); ?>" aria-label="Twitter">
                                <i class="fa-brands fa-twitter"></i></a>
                            </li>
                            <li><a href="<?php echo e($settings->valueOf('snapchat')); ?>" aria-label="Snapchat"><span
                                        class="fab fa-snapchat"></span></a></li>
                            <li><a href="<?php echo e($settings->valueOf('instagram')); ?>" aria-label="Instagram"><span
        ...
        <div class="container">
            <div class="d-flex align-items-center p-relative">
                ...
                <div class="header-logo flex-1">
                    <div class="logo">
                        <a href="<?php echo e(route('home')); ?>" title="AbayaSquare" rel="home" target="_parent">
                            <img src="<?php echo e(asset('assets/img/logo.webp')); ?>" alt="" width="70" height="84">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="nav-desktop">
                        <div class="primary-menu-container">
                            <ul id="mega_main_menu_ul" class="nav-menu">
                                ...
                                <li><a href="<?php echo e(route('web.products')); ?>" target="_parent"><?php echo app('translator')->get('site.all'); ?></a></li>
                                <li class="menu-item menu-item-has-children dropdown"><a href="<?php echo e(route('stores')); ?>"
                                        target="_parent"><?php echo app('translator')->get('site.designers'); ?></a>
                                    <ul class="sub-menu default">
                                        <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><a href="<?php echo e(route('store', ['id' => $store->id])); ?>"
                                                    target="_parent"><?php echo e($store->name); ?></a></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </li>
                                <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="<?php echo e(route('cat', ['id' => $cat->id])); ?>"
                                            target="_parent"><?php echo e($cat->name); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="header-right d-flex align-items-center justify-content-end">
                    <div class="apps-logo d-none d-md-block">
                        <a href="<?php echo e($settings->valueOf('ios')); ?>">
                            <img src="<?php echo e(asset('assets/img/Apple_Store_logo.png')); ?>" alt="Apple_Store_logo" width="30" height="30">
                        </a>
                        <a href="<?php echo e($settings->valueOf('android')); ?>">
                            <img src="<?php echo e(asset('assets/img/play-store-icon.svg')); ?>" alt="play-store-icon" width="30" height="30">
                        </a>
                    </div>
                    <div class="search-switcher d-none d-md-block">
                        <span class="search-opener"><i class="fal fa-search"></i></span>
                        <form role="search" method="get" class="search-form-container" action="<?php echo e(route('search')); ?>">

                            <div class="popup-overlay"></div>
                            <div class="search-content-popup">
                                <span class="close-popup pointer" href="" target="_parent"><i
                                        class="fal fa-times"></i></span>
                                <h3><?php echo app('translator')->get('site.search_text'); ?></h3>
                        ...
                        <div class="acc-form-padding">
                            <div class="acc-link acc-buttons">
                                <?php if(Auth::guard('user')->check()): ?>
                                    <a class="lost-pwlink" href="<?php echo e(route('profile')); ?>" title="<?php echo app('translator')->get('site.profile'); ?>"
                                        id="login-inline" target="_parent">
                                        <i class="fal fa-user"></i>
                                    </a>
                                <?php else: ?>
                                    <a class="lost-pwlink" href="<?php echo e(route('login')); ?>" title="<?php echo app('translator')->get('site.login-register'); ?>"
                                        id="login-inline" target="_parent">
                                        <i class="fal fa-user"></i>
                                    </a>
                                <?php endif; ?>
                    ...
                    <div class="wl-icon-wrapper  d-none d-md-block">
                        <a title="View wishlist" href="<?php echo e(route('favs')); ?>" target="_parent">
                    ...
                    <div class="topcart">
                        <span class="cart-toggler toggle-cartside pointer" target="_parent">
                            <span class="content-cart">
                                ...
                                <span class="qty qty-count"><?php echo e(\Cart::getTotalQuantity()); ?></span>
                            </span>
                        </span>
                    </div>
                </div>
    ...
    <!--======================= Start footer ==========================-->
    <footer class="footer bg_lazy" data-original="<?php echo e(asset('assets/img/5.webp')); ?>">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 site_info">
                        <a href="<?php echo e(route('home')); ?>" class="logo" aria-label="Home">
                            <img src="<?php echo e(asset('assets/img/logo.webp')); ?>" alt="" width="60" height="72">
                        </a>
                        <p class="desc"><?php echo app('translator')->get('site.footer_text'); ?></p>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div>
                            <h4 class="head mb-20"><?php echo app('translator')->get('site.linkes'); ?></h4>
                            <ul class="services_box">
                                <li>
                                    <a href="<?php echo e(route('web.products')); ?>">
                                ...
                                <li>
                                    <a href="<?php echo e(route('home')); ?>">
                                        <i class="fal fa-angle-double-left"></i>
                                        <span><?php echo app('translator')->get('site.home'); ?></span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="<?php echo e(route('contact')); ?>">
                                        <i class="fal fa-angle-double-left"></i>
                                        <span><?php echo app('translator')->get('site.contact'); ?></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('terms')); ?>">
                                        <i class="fal fa-angle-double-left"></i>
                                        <span><?php echo app('translator')->get('site.terms'); ?></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('privacy')); ?>">
                                        <i class="fal fa-angle-double-left"></i>
                                        <span><?php echo app('translator')->get('site.privacy'); ?></span>
                                    </a>
                                </li>
                                <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="<?php echo e(route('cat', ['id' => $item->id])); ?>">
                                            <i class="fal fa-angle-double-left"></i>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <h4 class="head mb-20"><?php echo app('translator')->get('site.download_app'); ?></h4>
                        <div class="apps_box">
                            <a href="<?php echo e($settings->valueOf('android')); ?>" target="_blank" aria-label="Android App">
                                <img data-src="<?php echo e(asset('assets/img/google-btn.svg')); ?>" class="lazyload" width="165" height="49" alt=""></a>
                            <a href="<?php echo e($settings->valueOf('ios')); ?>" target="_blank" aria-label="Ios App">
                                <img data-src="<?php echo e(asset('assets/img/apple-btn.svg')); ?>" class="lazyload" width="165" height="49" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div>
                            <h4 class="head mb-20"><?php echo app('translator')->get('site.contact'); ?></h4>
                            <div class="sochial">
                                <a href="<?php echo e($settings->valueOf('twitter')); ?>" target="_blank" aria-label="Twitter"><i
                                        class="fab fa-twitter"></i></a>
                                <a href="<?php echo e($settings->valueOf('snapchat')); ?>" target="_blank" aria-label="Snapchat"><i
                                        class="fab fa-snapchat"></i></a>
                                <a href="<?php echo e($settings->valueOf('instagram')); ?>" target="_blank" aria-label="Instagram"><i
                                        class="fab fa-instagram"></i></a>
                            </div>
                            <div class="contact-info mt-30">
                                <a href="tel:<?php echo e($settings->valueOf('mobile')); ?>" class="flex-h" aria-label="Call">
                                    <i class="fal fa-phone"></i>
                                    <span><?php echo e($settings->valueOf('mobile')); ?></span>
                                </a>
                                <a href="mailto:<?php echo e($settings->valueOf('email')); ?>" class="flex-h" aria-label="Mail">
                                    <i class="fal fa-envelope"></i>
                                    <span><?php echo e($settings->valueOf('email')); ?></span>
                                </a>
                            </div>
                            <div class="mt-20 text-center">
                                <img data-src="<?php echo e(asset('assets/img/pay.webp')); ?>" class="lazyload" alt="">
                                <p style="font-size: 13px; margin: 7px 0 0; font-weight: 600; color: #d3dee4;"><?php echo app('translator')->get('site.secpay'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="copyrights text-center p-relative">
                <p class="m-0">&copy; <?php echo app('translator')->get('site.rights'); ?> <strong><a href="<?php echo e(route('home')); ?>"
                            style="color:#988a76;" aria-label="Site"> <?php echo e($settings->valueOf('project_name_' . $lang)); ?></a></strong></p>
            </div>
            <!--======================= End copy rights ==========================-->
        </div>
    </footer>
    ...
    <div class="footer_sochial">
        <a href="https://wa.me/<?php echo e($settings->valueOf('whatsapp')); ?>" class="whatsapp" data-toggle="tooltip"
            data-placement="right" title="<?php echo e(trans('site.send_whatsapp')); ?>" target="_blank" aria-label="Whatsapp"><i
                class="fab fa-whatsapp"></i></a>
        <a href="tel:<?php echo e($settings->valueOf('mobile')); ?>" class="mobile" data-toggle="tooltip"
            data-placement="right" title="<?php echo e(trans('site.call')); ?>" aria-label="Call"><i class="fas fa-phone"></i></a>
    </div>
    <!--======================== End footer sochial =============================-->
    ...
    <div class="cart-side-content">
        ...
        <div class="cart-widget-content">
            <div class="widget woocommerce widget_shopping_cart">
                <h2 class="widgettitle"><span><?php echo app('translator')->get('site.cart'); ?></span><span class="toggle-cartside pointer"
                ...
                <div class="widget_shopping_cart_content">
                        ...
                        <ul class="woocommerce-mini-cart cart_list product_list_widget">
                            ...
                            <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="woocommerce-mini-cart-item mini_cart_item">
                                        ...
                                        <a href="<?php echo e(route('single_product', $item->attributes->product_id)); ?>" target="_parent">
                                            <img width="70" height="100" src="<?php echo e($item->attributes->image); ?>"
                                                class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                                alt="" loading="lazy">
                                            <div class="info-m">
                                                <span class="d-block name"><?php echo e($item->name); ?></span>
                                                <span class="quantity"><?php echo e($item->quantity); ?> ×
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi><?php echo e($item->price); ?><span
                                                                class="woocommerce-Price-currencySymbol"><?php echo app('translator')->get('site.rs'); ?></span></bdi>
                                                    </span>
                                                </span>
                                            </div>
                                        </a>
                    ...
                    <div class="minicart-bottom">
                        <p class="woocommerce-mini-cart__total total"><strong><?php echo app('translator')->get('site.cart4'); ?>:</strong> <span
                                class="woocommerce-Price-amount amount"><bdi><?php echo e(\Cart::getSubTotal()); ?> <span
                                        class="woocommerce-Price-currencySymbol"><?php echo app('translator')->get('site.rs'); ?></span></bdi>
                            </span>
                        </p>
                        <p class="woocommerce-mini-cart__buttons buttons">
                            <a href="<?php echo e(route('cart')); ?>" class="button wc-forward"
                                target="_parent"><?php echo app('translator')->get('site.cart5'); ?></a>
                            <a href="<?php echo e(route('checkout')); ?>" class="button checkout wc-forward"
                                target="_parent"><?php echo app('translator')->get('site.cart6'); ?></a>
                        </p>
                    </div>
    ...
    <div class="mobile-navigation hidden-md hidden-lg">
        <div id="close-menu-moblie"><a href="#" target="_parent" aria-label="Close"><?php echo app('translator')->get('site.close'); ?><i class="fal fa-times"></i></a></div>
        <form role="search" method="get" class="search-form-container" action="<?php echo e(route('search')); ?>">
            ...
            <div class="mobile-menu-container">
                <ul id="menu-main-menu" class="nav-menu mobile-menu">
                    ...
                    <li
                        ...
                        <a href="<?php echo e(route('stores')); ?>" target="_parent"><?php echo app('translator')->get('site.designers'); ?></a>
                        <ul class="sub-menu">
                            <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(route('store', ['id' => $store->id])); ?>"
                                        target="_parent"><?php echo e($store->name); ?></a></li>
                    ...
                    <li><a href="<?php echo e(route('contact')); ?>" target="_parent"><?php echo app('translator')->get('site.contact'); ?></a></li>
                </ul>
            </div>
        </div>
        <div class="my-account-link">
            <?php if(Auth::guard('user')->check()): ?>
                <a href="<?php echo e(route('profile')); ?>" title="" target="_parent"><?php echo app('translator')->get('site.profile'); ?><i
                        class="fal fa-user"></i></a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" title="" target="_parent"><?php echo app('translator')->get('site.login-register'); ?><i
                        class="fal fa-user"></i></a>
            <?php endif; ?>
        </div>
        <div class="wishlist-link">
            <a href="<?php echo e(route('favs')); ?>" target="_parent">
                <?php echo app('translator')->get('site.special_products'); ?><i class="fal fa-heart"></i>
            </a>
        </div>
        <div class="flex-h flex-between" style="margin-top: 15px">
            <ul class="social-links clearfix">
                <li><a href="<?php echo e($settings->valueOf('twitter')); ?>" aria-label="Twitter"><span class="fab fa-twitter"></span></a>
                </li>
                <li><a href="<?php echo e($settings->valueOf('snapchat')); ?>" aria-label="Snapchat"><span
                            class="fab fa-snapchat"></span></a></li>
                <li><a href="<?php echo e($settings->valueOf('instagram')); ?>" aria-label="Instagram"><span
    ...
    <ul class="side-sticky-icons">
        <li class="quick-compare">
            <a class="home-link" href="<?php echo e(route('home')); ?>" target="_parent"><span
        ...
        <li class="quick-cart">
            <span class="toggle-cartside" target="_parent"><span
                    class="badge"><?php echo e(\Cart::getTotalQuantity()); ?></span>
        ...
        <li class="quick-wishlist">
            <a href="<?php echo e(route('favs')); ?>" target="_parent" aria-label="Fav"><span class="fal fa-heart icons"></span></a>
        </li>
        <li>
            <?php if(Auth::guard('user')->check()): ?>
                <a href="<?php echo e(route('profile')); ?>" target="_parent"><span class="fal fa-user icons"></span></a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" target="_parent"><span class="fal fa-user icons"></span></a>
            <?php endif; ?>
        </li>
    </ul>
    ...
    <script src="<?php echo e(asset('assets/vendor/lazysizes.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/owl.carousel/owl.carousel.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/greensock.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/ScrollMagic.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/animation.gsap.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/vendor/odometer.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/viewport.jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/jquery.nice-select.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/jquery.lazyload.min.js')); ?>"></script>
...
<?php /**PATH /home/abayasquare/public_html/new/resources/views/web/master.blade.php ENDPATH**/ ?>