...
'add_url'=>'system.categories.create',
'module'=>'categories',
'actions'=>[
        [
           'route'=>'system.categories.activate',
           'icon'=>config('layout.icons.activate_icon'),
           'text'=>'تفعيل',
           'role'=>"activate",
       ],
       [
           'route'=>'system.categories.deactivate',
           'icon'=>config('layout.icons.deactivate_icon'),
           'text'=>'تعطيل',
           'role'=>"activate",
       ],
        [
            'route'=>'system.categories.delete',
                ...
                <div class="col">
                    <form class="form-inline" style="float: right">
                        <div class="form-group m-form__group">
                            ...
                            <?php $__env->startComponent('components.serach.inputwithsearch',['inputs'=>['name'=>'اسم التصنيف']]); ?>
                            <?php echo $__env->renderComponent(); ?>
                            <a href="<?php echo e(route('system.categories.index')); ?>"
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php $__currentLoopData = $out; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="TR_<?php echo e($o->id); ?>">
                                    ...
                                    <td>
                                        <img style="background-color: #ccc;" src="<?php echo e($o->image_url); ?>" class="img_table"
                                             alt="">
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <p><?php echo e($o->products_count); ?></p>
                                    </td>
                                    <td class="text-center">
                                        <?php if($o->status == 1): ?>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <ul class="list-inline">
                                            <?php if(auth('system_admin')->user()->can('edit_categories','system_admin')): ?>
                                                <li>
                                                    <a href="<?php echo e(route('system.categories.update',$o->id)); ?>"
                                            ...
                                            <?php endif; ?>
                                            <?php if(auth('system_admin')->user()->can('delete_categories','system_admin')): ?>
                                                <li>
                                                    ...
                                                    <button class="<?php echo e(config('layout.classes.delete')); ?> mt-2 btn-del"
                                                            ...
                                                            data-url="<?php echo e(route('system.categories.delete')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/new/resources/views/system_admin/categories/index.blade.php ENDPATH**/ ?>