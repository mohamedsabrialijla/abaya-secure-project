            ...
            <div class="col-10">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?php $__env->startComponent('components.upload_image',['data'=>$out->image,'name'=>'image','text' => 'صورة العرض','hint'=>'']); ?>
                   <?php echo $__env->renderComponent(); ?>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/resources/views/system_admin/offers/update.blade.php ENDPATH**/ ?>