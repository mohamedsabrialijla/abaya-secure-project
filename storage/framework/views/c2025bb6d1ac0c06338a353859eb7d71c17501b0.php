...
<?php echo app('translator')->get('site.most_selling'); ?>
<?php $__env->stopSection(); ?>
    ...
    <div class="container">
        <div class="product-navigation">
            <ul class="breadcrumb breadcrumb-lg m-0">
                ...
                <li><?php echo app('translator')->get('site.most_selling'); ?></li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="designer_header">
            <div class="designer_box">
                ...
                <div class="info mb-0">
                    <h5 class="m-0"><?php echo app('translator')->get('site.most_selling'); ?></h5>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('web.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/new/resources/views/web/most_sell.blade.php ENDPATH**/ ?>