...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.breadcrumbs','data' => ['breadcrumbs' => [
        ...
        ['page' => route('system.orders.mainIndex'), 'title' => 'الطلبات الخاصة بالكوبون'],
    ]]]); ?>
...
<?php $__env->startSection('page_content'); ?>
    ...
    <?php $__env->startComponent('components.ShowCard',
        [
            'Disname' => 'الطلبات الخاصة بالكوبون ' . @$coupon->code,
            'Disinfo' => 'ادارة الطلبات الخاصة بالكوبون " ' . @$coupon->code . ' " في الموقع',
            'module' => 'coupons',
            'print' => '',
        ]); ?>
                                        ...
                                        <ul class="list-inline">
                                            ...
                                            <li>
                                                <?php if(auth('system_admin')->user()->can('edit_orders', 'system_admin') ||
                                                    ...
                                                    <a href="<?php echo e(route('system.orders.details', $o->id)); ?>"
                                                        class="<?php echo e(config('layout.classes.edit')); ?>" >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/resources/views/system_admin/coupons/orders.blade.php ENDPATH**/ ?>