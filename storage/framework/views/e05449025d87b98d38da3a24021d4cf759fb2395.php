...
'Disname'=>'المقاسات',
'Disinfo'=>'ادارة المقاسات',
'add_url'=>'system.sizes.create',
'module'=>'sizes',
'actions'=>[
        [
           'route'=>'system.sizes.activate',
           'icon'=>config('layout.icons.activate_icon'),
           'text'=>'تفعيل',
           'role'=>"activate",
       ],
       [
           'route'=>'system.sizes.deactivate',
           'icon'=>config('layout.icons.deactivate_icon'),
           'text'=>'تعطيل',
           'role'=>"activate",
       ],
       [
            'route'=>'system.sizes.delete',
                ...
                <div class="col">
                    <form class="form-inline" style="float: right">
                        <div class="form-group m-form__group">
                            ...
                            <?php $__env->startComponent('components.serach.inputwithsearch',['inputs'=>['name'=>'اسم المقاس']]); ?>
                            <?php echo $__env->renderComponent(); ?>
                            <a href="<?php echo e(route('system.sizes.index')); ?>"
                                ...
                                <tr id="TR_<?php echo e($o->id); ?>">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <ul class="list-inline">
                                            ...
                                            <?php if(auth('system_admin')->user()->can('edit_sizes','system_admin')): ?>

                                                <li>
                                                    <a href="<?php echo e(route('system.sizes.update',$o->id)); ?>"
                                            ...
                                            <?php endif; ?>
                                            <?php if(auth('system_admin')->user()->can('delete_sizes','system_admin')): ?>
                                                ...
                                                <li>
                                                    ...
                                                    <button class="<?php echo e(config('layout.classes.delete')); ?> mt-2 btn-del"
                                                            ...
                                                            data-url="<?php echo e(route('system.sizes.delete')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/resources/views/system_admin/sizes/index.blade.php ENDPATH**/ ?>