                    ...
                    <div class="card-toolbar">
                        <div class="card-toolbar">
                            ...
                            <?php if(auth('system_admin')->user()->can('edit_orders', 'system_admin')): ?>
                                ...
                                <button type="button" class="<?php echo e(config('layout.classes.edit')); ?> mt-2" data-toggle="modal"
                                    data-target="#editpay" data-bs-target="#editpay"><i class="fa fa-edit"></i>
                                    تعديل طريقة الدفع
                                </button>

                                <div class="modal fade" tabindex="-1" id="editpay">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?php echo e(route('system.orders.editpay', ['id' => $order->id])); ?>"
                                                method="post">
                                                <?php echo csrf_field(); ?>
                                                <div class="modal-body">
                                                    <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <select class="form-select form-select-solid" data-control="select2"
                                                            data-placeholder="اختار طريقة الدفع" data-allow-clear="true"
                                                            name="pay">
                                                            <option></option>
                                                            <?php $__currentLoopData = $paymentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($pay->id); ?>"
                                                                    <?php if($order->payment_type_id == $pay->id): ?> selected <?php endif; ?>>
                                                                    <?php echo e($pay->name_ar); ?></option>
                                ...
                                <div class="col-sm-9">
                                    <div class="order-status-btn">
                                        <?php if(auth('system_admin')->user()->can('edit_orders', 'system_admin')): ?>
                                            ...
                                            <?php if($order->case_id == 4 || $order->case_id == 5|| $order->case_id == 6|| $order->case_id == 7|| $order->case_id == 8): ?>

                                            <a href="http://www.sls-express.com/api/v1/order/waybill?api_token=IhexECgpAL84uzUb8uYWzdT1iDktRaX7f7nXjSE28t&tracking_number=<?php echo e($order->shipment_id); ?>" target="_blank" class="<?php echo e(config('layout.classes.add')); ?>">
                                            طباعة البوليصة
                                            </a>
                                            <a href="http://www.sls-express.com/tracking?tracking_number=<?php echo e($order->shipment_id); ?>" target="_blank"  class="<?php echo e(config('layout.classes.add')); ?>">
                                                تتبع الشحنة
                                            </a>
                ...
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <div class="card-toolbar">
                            <?php if(auth('system_admin')->user()->can('edit_orders', 'system_admin')): ?>
                                <!-- Button trigger modal -->
                                <button type="button" class="<?php echo e(config('layout.classes.edit')); ?> mt-2"
                                    data-toggle="modal" data-target="#addproduct" data-bs-target="#addproduct"><i
                                        class="la la-plus"></i>
                                    إضافة منتج للفاتورة
                                </button>
                                ...
                                <div class="modal fade" tabindex="-1" id="addproduct">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">إضافة منتج للفاتورة</h5>
                                            ...
                                            <form action="<?php echo e(route('system.orders.addproduct', ['id' => $order->id])); ?>"
                                                method="post">
                                                <?php echo csrf_field(); ?>
                                                <div class="modal-body">
                                                    <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <select class="form-select form-select-solid"
                                                            data-control="select2" data-placeholder="اختار المنتج"
                                                            data-allow-clear="true" name="product" required>
                                                            <option></option>
                                                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($product->id); ?>">
                                                                    <?php echo e($product->name_ar); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                                        <!--begin::Label-->
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                            <span class="required">المقاس</span>

                                                        </label>
                                                        <select class="form-select form-select-solid"
                                                            data-control="select2" data-placeholder="اختار المقاس"
                                                            data-allow-clear="true" name="size" required>
                                                            <option></option>
                                                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($size->id); ?>"><?php echo e($size->name_ar); ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <?php $__env->startComponent('components.input', ['name' => 'qty', 'text' => 'الكمية']); ?>
                                                        <?php echo $__env->renderComponent(); ?>
                                                    </div>

                                                    <div class="col-md-6">
                                                        <?php $__env->startComponent('components.input', ['name' => 'replace', 'text' => 'رسوم الاستبدال', 'icon' => 'fa-dollar']); ?>
                                                        <?php echo $__env->renderComponent(); ?>
                                                    </div>
                                                </div>
                                        ...
                                        <td>
                                            <?php if(auth('system_admin')->user()->can('edit_orders', 'system_admin')): ?>
                                                <button class="<?php echo e(config('layout.classes.delete')); ?> mt-2 btn-del"
                                                    data-id="<?= $product->id ?>" data-toggle="tooltip" data-theme="dark"
                                                    data-url="<?php echo e(route('system.orders.deleteproduct')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/resources/views/system_admin/orders/edit.blade.php ENDPATH**/ ?>