    ...
    <div class="container">
        <div class="product-navigation">
            <ul class="breadcrumb breadcrumb-lg m-0">
                ...
                <li><?php echo app('translator')->get('site.search'); ?></li>
                    ...
                    <div class="box_product wow fadeInUp">
                        ...
                        <div class="product-details">
                            ...
                            <div class="product-action">
                                ...
                                <a href="<?php echo e(route('single_product', ['id' => $m->id])); ?>" data-toggle="modal"
...
<?php echo $__env->make('web.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/new/resources/views/web/search.blade.php ENDPATH**/ ?>