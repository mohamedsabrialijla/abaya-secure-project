            ...
            <div class="col-md-10">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php $__env->startComponent('components.input',['name'=>'mobile','data'=>substr($out->mobile, 3, 12),'text'=>'رقم الجوال','placeholder'=>'ادخل رقم الجوال','icon'=>'fa-phone']); ?>
                        <?php echo $__env->renderComponent(); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <?php $__env->startComponent('components.select',['data'=>@$myRole->role_id,'name'=>'roles','text'=>'الصلاحيات','placeholder'=>'اختر الصلاحيات','icon'=>'fa-cog','select'=>$roles]); ?>
                        <?php echo $__env->renderComponent(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abayasquare/public_html/resources/views/system_admin/admins/update.blade.php ENDPATH**/ ?>