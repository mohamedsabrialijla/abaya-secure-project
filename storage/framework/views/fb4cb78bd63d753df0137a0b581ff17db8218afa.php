<div class="imageCont 
    ...
    <div class="imageContainer">
        <label for="MYimage_<?php echo e($name); ?>" style="width: 100%;cursor: pointer;">
            ...
            <img src="<?php echo e((isset($data) && $data)? url('uploads/' .$data) : url('blank.png')); ?>"
                 style="<?php echo e(isset($imgStyle)??"width: 100%"); ?>;" class="MyImagePrivew thumbnail"
                 alt="">
...
<?php /**PATH /home/abayasquare/public_html/resources/views/components/uploadModalImage.blade.php ENDPATH**/ ?>